  ...
  return (
    <footer className="relative mt-20">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="rounded-3xl border border-indigo-500/15 bg-[rgba(10,10,30,0.80)] backdrop-blur-2xl shadow-[0_20px_50px_-30px_rgba(0,0,0,0.40),0_0_40px_-10px_rgba(99,102,241,0.12),inset_0_1px_0_rgba(255,255,255,0.04)] p-6 sm:p-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="#about" className="text-slate-400 hover:text-amber-400 transition-colors text-sm font-medium">
                  {t.nav.about}
                </a>
              </li>
              <li>
                <a href="#projects" className="text-slate-400 hover:text-orange-400 transition-colors text-sm font-medium">
                  {t.nav.projects}
                </a>
              </li>
              <li>
                <a href="#contact" className="text-slate-400 hover:text-rose-400 transition-colors text-sm font-medium">
                  {t.nav.contact}
                </a>
              </li>
            </ul>
              ...
              {socialLinks.map((social) => {
                ...
                return (
                  <motion.a
                    ...
                    whileTap={{ scale: 0.95 }}
                    className={`p-2.5 rounded-xl bg-[rgba(15,15,40,0.60)] border border-white/10 text-slate-400 shadow-[0_10px_22px_-18px_rgba(0,0,0,0.5)] transition-all ${social.hoverColor}`}
