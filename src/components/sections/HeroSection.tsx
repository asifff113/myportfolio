        ...
        <div className="relative rounded-[2rem] section-shell p-6 sm:p-8 lg:p-10 overflow-hidden">
          ...
          >
            ...
            <div className="text-center lg:text-left order-2 lg:order-1">
              ...
              >
                <span className="bg-gradient-to-r from-indigo-400 via-violet-400 to-cyan-400 bg-clip-text text-transparent drop-shadow-[0_4px_12px_rgba(99,102,241,0.4)]">
                  {personalInfo.name}
                </span>
              </motion.h1>
              ...
              <motion.h2
                variants={itemVariants}
                className="text-xl sm:text-2xl md:text-3xl font-semibold mb-6 text-slate-300 leading-tight"
              >
              ...
              >
                <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-indigo-500/15 border border-indigo-500/30 text-indigo-300 shadow-sm">
                  <Sparkles className="inline w-3 h-3 mr-1" />
                  Multi-color UI
                </span>
                <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-cyan-500/15 border border-cyan-500/30 text-cyan-300">
                  Futuristic Motion
                </span>
                <span className="px-3 py-1.5 rounded-full text-xs font-semibold bg-violet-500/15 border border-violet-500/30 text-violet-300">
                  3D Visuals
                </span>
              </motion.div>
            ...
            >
              <div className="relative">
                {/* Outer aurora glow */}
                <div className="absolute -inset-10 rounded-full bg-[conic-gradient(from_120deg,rgba(99,102,241,0.20),rgba(6,182,212,0.18),rgba(244,63,94,0.15),rgba(16,185,129,0.15),rgba(99,102,241,0.20))] blur-3xl animate-[spin_20s_linear_infinite]" />
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="absolute -bottom-3 left-1/2 -translate-x-1/2 sm:left-auto sm:translate-x-0 sm:right-2 rounded-2xl bg-[rgba(10,10,30,0.85)] border border-indigo-500/20 backdrop-blur-xl px-4 py-3 shadow-[0_12px_28px_-16px_rgba(0,0,0,0.4)] min-w-[190px]"
                  >
