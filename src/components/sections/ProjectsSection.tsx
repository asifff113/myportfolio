...
const typeColors: Record<string, string> = {
  ...
  Freelance: "bg-orange-500/20 text-orange-300 border border-orange-200/60",
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          ...
          {/* Date */}
          {project.endDate && (
            <span className="inline-flex items-center gap-1 px-3 py-1 bg-orange-500/15 border border-orange-200/40 rounded-full text-xs text-slate-400">
              <Calendar size={12} />
          ...
          <div className="mb-4">
            <div className="flex flex-wrap gap-1.5">
              {project.techStack.slice(0, featured ? 8 : 5).map((tech, index) => (
                <span
                  key={index}
                  className="bg-orange-500/15 border border-orange-200/40 text-orange-300 rounded-md px-2 py-1 text-xs"
                >
                  {tech}
                </span>
              ))}
        ...
        {/* Links & Actions */}
        <div className="flex items-center justify-between gap-3 text-sm mt-auto pt-4 border-t border-orange-500/20">
